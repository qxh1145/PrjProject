<%-- 
    Document   : strawberryDaiquiri
    Created on : Jun 6, 2025, 10:53:52 PM
    Author     : anhth
--%>
...
<html>
    <head>
        ...
        <title>Recipe Strawberry Daiquiri</title>
    ...
    <body>
        <!-- Recipe Header -->
        <div class="recipe-header" style="--header-image: url('https://images.unsplash.com/photo-1552058544-f2b08422138a?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')">
            <h1>How to Make a Strawberry Daiquiri</h1>
            <p>A refreshing, fruity twist on the classic rum cocktail</p>
        </div>
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Strawberry Daiquiri</li>
                </ol>
            </nav>
            ...
            <div class="card">
                ...
                <ul class="list">
                    <li class="list-item">2 oz (60ml) white rum</li>
                    <li class="list-item">1 oz (30ml) fresh lime juice</li>
                    <li class="list-item">3/4 oz (22ml) simple syrup</li>
                    <li class="list-item">4-5 fresh strawberries, hulled</li>
                    <li class="list-item">Ice cubes</li>
                    <li class="list-item">Strawberry or lime wedge for garnish</li>
                </ul>
            </div>
            ...
            <div class="card">
                ...
                <ol class="steps-list">
                    <li class="step-item">Add the fresh strawberries and simple syrup into a blender and blend until smooth.</li>
                    <li class="step-item">Add the white rum, fresh lime juice, and ice cubes to the blender.</li>
                    <li class="step-item">Blend until the mixture is smooth and slushy.</li>
                    <li class="step-item">Pour into a chilled cocktail glass.</li>
                    <li class="step-item">Garnish with a strawberry or lime wedge.</li>
                </ol>
            </div>
            ...
            <div class="card">
                <div class="tips">
                    ...
                    <ul class="tips-list">
                        <li class="tips-item">Use ripe, fresh strawberries for the best flavor.</li>
                        <li class="tips-item">Adjust the sweetness by varying the amount of simple syrup.</li>
                        <li class="tips-item">You can use frozen strawberries for a thicker slush.</li>
                    </ul>
                </div>
            </div>
