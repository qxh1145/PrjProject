<%-- 
    Document   : negroni
    Created on : Jun 6, 2025, 10:34:09 PM
    Author     : anhth
--%>
...
<html>
    ...
    <body>
        <!-- Recipe Header -->
        <h1>Hello World!</h1><div class="recipe-header" style="--header-image: url('https://images.unsplash.com/photo-1642257543142-d66cf3e2ef33?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')">
