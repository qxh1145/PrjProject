<%-- 
    Document   : martini
    Created on : Jun 6, 2025, 10:32:58 PM
    Author     : anhth
--%>
...
<html>
    ...
    <body>
        <!-- Recipe Header -->
        <div class="recipe-header" style="--header-image: url('https://images.unsplash.com/photo-1623141363455-df5fe6c94c69?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')">
            <h1>How to Make a Martini</h1>
            <p>The iconic gin and vermouth cocktail, served chilled with a twist</p>
        </div>
        ...
        <div class="container">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Martini</li>
                </ol>
            </nav>
            ...
            <div class="card">
                ...
                <ul class="list">
                    <li class="list-item">2 1/2 oz (75ml) gin</li>
                    <li class="list-item">1/2 oz (15ml) dry vermouth</li>
                    <li class="list-item">Ice cubes</li>
                    <li class="list-item">Lemon twist or olive for garnish</li>
                </ul>
            </div>
            ...
            <div class="card">
                ...
                <ol class="steps-list">
                    <li class="step-item">Pour gin and dry vermouth into a mixing glass filled with ice.</li>
                    <li class="step-item">Stir (or shake, depending on preference) until well chilled.</li>
                    <li class="step-item">Strain into a chilled martini or coupe glass.</li>
                    <li class="step-item">Garnish with a lemon twist or olive.</li>
                </ol>
            </div>
            ...
            <div class="card">
                <div class="tips">
                    ...
                    <ul class="tips-list">
                        <li class="tips-item">Stirring gives a smoother texture; shaking makes it colder and more diluted.</li>
                        <li class="tips-item">Use fresh, high-quality gin and vermouth for the best flavor.</li>
                        <li class="tips-item">Experiment with vermouth ratio for a drier or wetter Martini.</li>
                    </ul>
                </div>
            </div>
