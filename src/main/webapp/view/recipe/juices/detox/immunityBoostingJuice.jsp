<%-- 
    Document   : immunityBoostingJuice
...
<head>
    ...
    <title>Immunity Boosting Juice Recipe</title>
...
<body>
    ...
    <!-- Recipe Header -->
    <div class="recipe-header" style="--header-image: url('https://i.pinimg.com/736x/d3/1b/eb/d31bebc977e6eaa15e28a29a70c49df0.jpg')">
        <h1>How to Make Immunity Boosting Juice</h1>
        <p>A delicious juice loaded with vitamins to support your immune system</p>
    </div>
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                ...
                <li class="breadcrumb-item active" aria-current="page">Immunity Boosting Juice</li>
            </ol>
        </nav>
        ...
        <div class="card">
            ...
            <ul class="list">
                <li class="list-item">2 oranges, peeled</li>
                <li class="list-item">1/2 lemon, juiced</li>
                <li class="list-item">1 carrot, chopped</li>
                <li class="list-item">1 inch ginger root</li>
                <li class="list-item">1 inch turmeric root (or 1 tsp powder)</li>
                <li class="list-item">1/2 tsp black pepper</li>
                <li class="list-item">1 tsp honey (optional)</li>
            </ul>
        </div>
        ...
        <div class="card">
            ...
            <ol class="steps-list">
                <li class="step-item">Peel and chop all fresh ingredients.</li>
                <li class="step-item">Add everything to a blender or juicer.</li>
                <li class="step-item">Blend until smooth. Strain if you prefer a clear juice.</li>
                <li class="step-item">Serve immediately for best taste and benefits.</li>
            </ol>
        </div>
        ...
        <div class="card">
            <div class="tips">
                ...
                <ul class="tips-list">
                    <li class="tips-item">Use fresh ginger and turmeric for stronger immune support.</li>
                    <li class="tips-item">Black pepper helps your body absorb turmeric's benefits.</li>
                    <li class="tips-item">Drink first thing in the morning to maximize absorption.</li>
                    <li class="tips-item">Chill before serving for a refreshing experience.</li>
                </ul>
            </div>
        </div>
