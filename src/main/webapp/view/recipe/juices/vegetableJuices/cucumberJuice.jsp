<%-- 
    Document   : cucumberJuice
    Created on : Jun 17, 2025, 3:31:02?PM
    Author     : ASUS
--%>
...
<body>
    ...
    <!-- Recipe Header -->
    <div class="recipe-header" style="--header-image: url('https://i.pinimg.com/736x/5e/a4/07/5ea40740532ceb76ed6c21526b632028.jpg')">
        <h1>How to Make Cucumber Juice</h1>
        <p>A cool, refreshing drink perfect for hydration and detox</p>
    </div>
    ...
    <div class="container">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                ...
                <li class="breadcrumb-item active" aria-current="page">Cucumber Juice</li>
            </ol>
        </nav>
        ...
        <div class="card">
            ...
            <ul class="list">
                <li class="list-item">2 medium cucumbers, peeled and chopped</li>
                <li class="list-item">1/2 lemon (juiced)</li>
                <li class="list-item">A few mint leaves (optional)</li>
        ...
        <div class="card">
            ...
            <ol class="steps-list">
                <li class="step-item">Wash and peel the cucumbers. Cut them into chunks.</li>
                <li class="step-item">If using a juicer, feed cucumbers and mint through the chute.</li>
                <li class="step-item">If using a blender, blend cucumber pieces with water until smooth.</li>
                <li class="step-item">Strain the juice through a strainer or cheesecloth for a smoother texture.</li>
                <li class="step-item">Add lemon juice and stir well.</li>
                <li class="step-item">Serve chilled. Garnish with mint leaves if desired.</li>
            </ol>
        </div>
        ...
        <div class="card">
            <div class="tips">
                ...
                <ul class="tips-list">
                    <li class="tips-item">Use fresh, firm cucumbers for the best flavor</li>
                    <li class="tips-item">Add a splash of lime or ginger for extra zing</li>
                    <li class="tips-item">Strain thoroughly for a smoother, lighter juice</li>
                    <li class="tips-item">Keep ingredients chilled before blending for a cooler drink</li>
                    <li class="tips-item">Consume immediately for maximum freshness</li>
                </ul>
            </div>
        </div>
