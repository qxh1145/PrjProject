    ...
    <style>
        ...
        * {
        ...
        .recipe-header {
            text-align: center;
            padding: 3rem 0;
            background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://i.shgcdn.com/313aa784-2ed4-4d05-ab8b-551ffb79ec36/-/format/auto/-/preview/3000x3000/-/quality/lighter/');
...
<body>
  ...
  <!-- Recipe Header -->
  <div class="recipe-header" style="--header-image: url('https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80')">
    <h1>How to Make a Sunset Cooler</h1>
    <p>A refreshing and colorful cocktail perfect for warm evenings</p>
  </div>
  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
      <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
        <li class="breadcrumb-item"><a href="<%= request.getContextPath() %>/indexLogin.jsp">Home</a></li>
            ...
            <li class="breadcrumb-item" style="margin: 0 10px;">/</li>
            <li class="breadcrumb-item active" aria-current="page">Sunset Cooler</li>
      </ol>
    </nav>
    ...
    <div class="card">
      ...
      <ul class="list">
        <li class="list-item">2 oz (60ml) vodka</li>
        <li class="list-item">3 oz (90ml) pineapple juice</li>
        <li class="list-item">1 oz (30ml) cranberry juice</li>
        <li class="list-item">1/2 oz (15ml) lime juice</li>
        <li class="list-item">Ice cubes</li>
        <li class="list-item">Pineapple slice or lime wedge for garnish</li>
      </ul>
    </div>
    ...
    <div class="card">
      ...
      <ol class="steps-list">
        ...
        <li class="step-item">Add vodka, pineapple juice, and lime juice. Stir gently.</li>
        <li class="step-item">Slowly pour cranberry juice over the back of a spoon to create a layered effect.</li>
        <li class="step-item">Garnish with a pineapple slice or lime wedge and serve immediately.</li>
      </ol>
    </div>
    ...
    <div class="card">
      <div class="tips">
        ...
        <ul class="tips-list">
          <li class="tips-item">Use chilled juices for a more refreshing drink.</li>
          <li class="tips-item">Pour cranberry juice slowly to maintain the sunset layers.</li>
          <li class="tips-item">Serve with a straw to enjoy the blend of flavors.</li>
        </ul>
      </div>
    </div>
      ...
      <div class="recipe-grid">
        <div class="recipe-card">
          ...
          <div class="recipe-content">
            ...
            <p class="recipe-description">A colorful and refreshing tropical cocktail</p>
            <a href="main?action=recipeDetail&path=view/recipe/cocktail/Mocktails/sunset-cooler.jsp" class="recipe-link">View Recipe →</a>
          </div>
        </div>
        <div class="recipe-card">
          <img src="https://static01.nyt.com/images/2023/08/17/multimedia/ND-Tequila-Sunrise/LH-Sangria-tjvl-threeByTwoMediumAt2X.jpg" class="recipe-image" alt="Tequila Sunrise" />
          <div class="recipe-content">
            <h3 class="recipe-name">Tequila Sunrise</h3>
            <p class="recipe-description">A classic tequila cocktail with orange and grenadine</p>
