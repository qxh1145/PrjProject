...
<head>
    ...
    <title>Matcha Milk Tea Recipe</title>
...
<body>
    ...
    <div class="recipe-header">
        <h1>Matcha Milk Tea</h1>
        <p>Earthy matcha with creamy milk and a touch of sweetness</p>
    </div>
    <div class="container">
        <!-- Breadcrumb -->
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                ...
                <li class="breadcrumb-item" style="margin: 0 10px;">/</li>
                <li class="breadcrumb-item active" aria-current="page">Matcha Milk Tea</li>
            </ol>
        </nav>
        <!-- Ingredients -->
        <div class="card">
            ...
            <ul class="list">
                <li class="list-item">2 tsp matcha powder</li>
                <li class="list-item">1/4 cup hot water (not boiling)</li>
                <li class="list-item">3/4 cup milk (or non-dairy alternative)</li>
                <li class="list-item">1-2 tbsp sugar or honey (to taste)</li>
        ...
        <div class="card">
            ...
            <ol class="steps-list">
                <li class="step-item">Whisk matcha powder with hot water until smooth and frothy.</li>
                <li class="step-item">Stir in sugar or honey until dissolved.</li>
        ...
        <div class="card">
            ...
            <ul class="tips-list">
                <li class="list-item">Use ceremonial grade matcha for best flavor and color.</li>
                <li class="list-item">Try with oat milk for a creamy vegan version.</li>
            </ul>
        </div>
    </div>
