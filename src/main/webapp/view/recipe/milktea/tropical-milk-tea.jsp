...
<head>
    ...
    <title>Tropical Milk Tea Recipe</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        body { background-color: #f5f5f5; color: #333; line-height: 1.6; }
        .container { max-width: 1200px; margin: 0 auto; padding: 2rem; }
        .recipe-header { text-align: center; padding: 3rem 0; background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=1350&q=80'); background-size: cover; background-position: center; color: white; margin-bottom: 3rem; }
...
<body>
    ...
    <div class="recipe-header">
        <h1>Tropical Milk Tea</h1>
        <p>Exotic flavors with a creamy milk tea base</p>
    </div>
    <div class="container">
        <!-- Breadcrumb -->
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                ...
                <li class="breadcrumb-item" style="margin: 0 10px;">/</li>
                <li class="breadcrumb-item active" aria-current="page">Tropical Milk Tea</li>
            </ol>
        </nav>
        <!-- Ingredients -->
        <div class="card">
            ...
            <ul class="list">
                ...
                <li class="list-item">1/2 cup coconut milk</li>
                <li class="list-item">1/4 cup pineapple juice</li>
        ...
        <div class="card">
            ...
            <ol class="steps-list">
                ...
                <li class="step-item">Add coconut milk and pineapple juice, mix well.</li>
                <li class="step-item">Pour over a glass filled with ice.</li>
                <li class="step-item">Garnish with pineapple slice if desired.</li>
            </ol>
        </div>
        <!-- Tips -->
        <div class="card">
            ...
            <ul class="tips-list">
                <li class="list-item">Try adding mango or passion fruit syrup for extra tropical flavor.</li>
                <li class="list-item">Use coconut cream for a richer drink.</li>
            </ul>
        </div>
    </div>
