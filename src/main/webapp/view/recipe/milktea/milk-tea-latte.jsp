...
<head>
    ...
    <title>Milk Tea Latte Recipe</title>
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@300;400;500;600&display=swap" rel="stylesheet">
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        body { background-color: #f5f5f5; color: #333; line-height: 1.6; }
        .container { max-width: 1200px; margin: 0 auto; padding: 2rem; }
        .recipe-header { text-align: center; padding: 3rem 0; background: linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url('https://images.unsplash.com/photo-1519864600265-abb23847ef2c?auto=format&fit=crop&w=1350&q=80'); background-size: cover; background-position: center; color: white; margin-bottom: 3rem; }
...
<body>
    ...
    <div class="recipe-header">
        <h1>Milk Tea Latte</h1>
        <p>Creamy and smooth, perfect for milk tea lovers</p>
    </div>
    <div class="container">
        <!-- Breadcrumb -->
        <nav aria-label="breadcrumb" class="mb-4">
            <ol class="breadcrumb" style="display: flex; list-style: none; padding: 0; margin: 0;">
                ...
                <li class="breadcrumb-item" style="margin: 0 10px;">/</li>
                <li class="breadcrumb-item active" aria-current="page">Milk Tea Latte</li>
            </ol>
        </nav>
        <!-- Ingredients -->
        <div class="card">
            ...
            <ul class="list">
                ...
                <li class="list-item">1/2 cup steamed milk</li>
        ...
        <div class="card">
            ...
            <ol class="steps-list">
                ...
                <li class="step-item">Steam the milk until frothy.</li>
                <li class="step-item">Pour the tea into a cup, add steamed milk on top.</li>
                <li class="step-item">Serve hot or over ice as desired.</li>
            </ol>
        </div>
        <!-- Tips -->
        <div class="card">
            ...
            <ul class="tips-list">
                <li class="list-item">Use whole milk for a creamier texture.</li>
                <li class="list-item">Try adding a dash of vanilla or honey for extra flavor.</li>
            </ul>
        </div>
    </div>
