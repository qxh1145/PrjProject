    ...
    <div class="comment-content">
        ...
        <div class="reply-form" id="reply-form-<%= comment.getCommentId() %>" style="display: none;">
            <div class="reply-input-container">
                ...
                <button class="reply-submit" onclick="addReply(<%= comment.getCommentId() %>, <%= recipeId %>)">
...
function addReply(parentCommentId, recipeId) {
    ...
    const formData = `action=comment&commentAction=addRecipeReply&recipeId=${recipeId}&parentCommentId=${parentCommentId}&commentText=${encodeURIComponent(replyText)}`;
